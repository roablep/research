      ...
      init: function (slots, pushBid, done) {
        ...
        ybotq.push(function() {
           ...
           for (var k = 0; k < slots.length; k++) {
               ...
               yieldbot.defineSlot(ybslot, {sizes: slot.sizes});
          ...
          for (var rbslot in rubiconSlots) {
            if (rubiconSlots.hasOwnProperty(rbslot)) {
              ...
              if (AddktHeader.shouldIncludeSlotInAuction(rbparams)) {
                ...
                if (rbparams.baseFloor > 0) {
                  //slotParams.rp_floor = rbparams.baseFloor;
                }
            ...
            for (var si = 0; si < respSlots.length; si++) {
              ...
              if (!ads || ads.length === 0) {
                ...
                for (var rbslt in rubiconSlots) {
                  if (rubiconSlots.hasOwnProperty(rbslt) &&
                      rubiconSlots[rbslt].slotName == slt.getElementId()) {
                    var rb_slot = rbslt;
